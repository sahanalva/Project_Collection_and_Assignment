...
ActiveRecord::Schema.define(version: 20_181_114_050_013) do
  ...
  create_table 'owns', force: :cascade do |t|
    ...
    t.index %w[user_id project_id], name: 'index_owns_on_user_id_and_project_id', unique: true
  ...
  create_table 'preferences', force: :cascade do |t|
    ...
    t.index %w[team_id project_id], name: 'index_preferences_on_team_id_and_project_id', unique: true
  ...
  create_table 'relationships', force: :cascade do |t|
    ...
    t.index %w[user_id team_id], name: 'index_relationships_on_user_id_and_team_id', unique: true
